        ...
        while (true) {
            ...
            if (operStack.isOper(ch)) {//如果是运算符
                ...
                if (!operStack.isEmpty()) {
                    //如果符号栈有操作符，就进行比较，如果当前的操作符的优先级小于或等于栈中的操作符，就需要从栈中pop出两个数
                    //再从符号栈中pop出一个符号，将得到结果，入数栈，然后将当前的操作符入符号栈
                ...
                //判断下一个字符是不是数字，如果是数字，就继续扫描，如果是运算符则入符号栈
                //注意是看后一位，不是index++
